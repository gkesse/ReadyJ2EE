...
set "GPROJECT_SRC=%GPROJECT_PATH%\app\code\readyapp\src\WEB-INF\sources"
set "GPROJECT_CLASS=%GPROJECT_PATH%\app\code\readyapp\src\WEB-INF\classes"
set "GMAIN_JAVA=%GPROJECT_SRC%\com\pkg\readyapp\GMain.java"
set "GWEB_ROOT=%GPROJECT_PATH%\app\code\readyapp\src"
::===============================================
set "CLASSPATH="
